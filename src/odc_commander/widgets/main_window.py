...
class OdcMainWindow(MainWindow):
    ...
    def __init__(self) -> None:
        super(OdcMainWindow, self).__init__()
    ...
    def add_controller_view(self, view: QWidget) -> None:
        ...
        with self.menu_bar.menu("View") as view_menu:
            with view_menu.menu("Tools") as tools_menu:
                with tools_menu.action(view.__class__.__name__) as view_action:
